...
- 거래소의 백오피스 설계 및 제작
- 레거시 코드 리펙토링 작업 진행
- 리눅스 배치 및 crontab 작업 구현

### 느낀점

기존 레거시 코드를 Laravel Framework에 맞추어 리펙토링 하였습니다.
거래소의 전반적인 기능을 리펙토링 하였으며 백오피스를 제작했습니다.
...
경매 시스템의 분석 및 설계 기능 구현하였습니다.
판매 등록, 입찰, 낙찰, 유찰, 알람 기능등을 구현하였습니다.
