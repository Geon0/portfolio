...
React-native로 프론트 구현 PHP Laravel 프레임 워크 Query Builder 사용 Api server 백엔드 구현했습니다.
초기 환경세팅 부터 마켓 업로드까지 모든 과정을 진행하며 앱 개발에 대한 전체적인 프로세스를 이해할 수 있었으며
앱은 웹과 다른 스택 구조를 사용하기 때문에 처음 적응하는데 시간이 걸렸습니다.
기획단계부터 참여했기 때문에 앱의 전반적인 프로세스를 이해하며 개발할 수 있었으며 AWS를 사용하여 개발하여 AWS 설정을 하며 인프라 지식을 얻을 수 있었습니다.
...
이더리움을 사용하여 NFT를 거래하는 거래소입니다.
Solidity를 사용하여 이더리움 메인넷과 연동되어 민팅할 수 있으며
블록체인의 기본개념을 이해하고 사용할 수 있는 프로젝트를 진행했습니다.
AWS ubuntu를 사용하며 구성하였으며 리눅스의 전반적인 사용법을 경험했습니다.
...
JSP, Servlet을 사용하여 제작하였으며 자체 솔루션을 사용하여 제작하였습니다.
기능 구현보다는 Exception 처리에 시간을 많이 할애했습니다.
